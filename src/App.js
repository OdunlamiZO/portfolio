					...
					<header className="header">
						...
						>
							<div>
								...
								<span id="directory" style={{ color: "darkblue" }}>
									~
								</span>
								<span style={{ color: "white" }}>$</span>
							</div>
							<div style={{ display: "flex", alignItems: "center" }}>
								<span id="command" style={{ color: "white" }}></span>
								<span
									...
									<div id="about" className="animate-pulse">
										...
										<div className="message animate-border">
											<p style={{ marginBottom: "15px" }}>
												My name is Odunlami Zacchaeus, I'm a backend developer
												based in Lagos, Nigeria. I have experience building with
												Java and its popular framework, Spring; PHP and Laravel;
												and Go. I have knowledge of SQL databases (MySQL &
												PostgreSQL) and I am an expert in building RESTful APIs
												and services; even GraphQL APIs.
											</p>
											<p>
												I have also some proficiency in frontend development,
												having strong knowledge of HTML; CSS3 and Tailwind CSS;
												and JavaScript with its popular library, React.
											</p>
